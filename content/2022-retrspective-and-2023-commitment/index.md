...
## 코글리즘
코틀린 알고리즘 스터디, 사실 스프링을 자바로만 쓰다가 코틀린을 사용하기 시작하면서 이미 존재하는 함수들이 있는지 모르고 만들어 쓰는 경우가 많았는데, 스터디 시작전부터 코틀린 공식문서를 한번 읽고 시작했던 부분이 크게 도움이 되었습니다.
...
## 영어 과외 & 헬스장 PT
오로지 개발만 키운다가 아닌 개발에 도움이 되는 것들도 조금씩은 채워가보자는 생각으로 영어 회화 과외와 갓생을 위한 건강을 위해 PT를 추가적으로 등록해서 다니고 있다.
...
우여곡절 끝에 운좋게 합류한 카카오스타일에 합류하게 되었다. 백엔드 개발자로서는 아직도 부족하지만 주변 동료들에게 민폐가 되지 않을 정도로 성장해보고자 한다.
...
## 개발 문화 및 스터디
팀 내에서 사용하고 있는 언어와 프레임워크는 Kotlin과 Spring Boot 이고 최소 2명의 리뷰가 Approve 되었을 때 머지를 진행할 수 있습니다.
